...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> SignUp(SignUpViewModel model)
    {
        ...
        if (result.Succeeded)
        {
            ...
            var message = new Message(new[] { user.Email }, "Confirmation email link", confirmationLink, null!);
        ...
        _logger.LogError("Sign up: {Errors}", result.Errors);
